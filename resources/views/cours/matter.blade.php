            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h3 class="page-title text-truncate text-dark font-weight-medium mb-1"> Matiere</h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="index.php">Mes matieres</a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
                            ...
                            <div class="card-img" style="background-image:url({{ asset('app-assets/assets/images/cours/informatique.png') }});">
                                <div class="overlay">
                                    <div class="overlay-content">
                                        <a class="hover" href="{{ route('all_cours',['id'=>$matiere->matiere_id]) }}">cours</a>
                                    </div>
                                </div>
                            </div>

                            <div class="card-content">
                                <a href="{{ route('all_cours',['id'=>$matiere->matiere_id]) }}">
