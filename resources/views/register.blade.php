            ...
            <div class="auth-box row text-center">
                ...
                <div class="col-lg-5 col-md-7 bg-white">
                    <div class="p-3">
                        ...
                        <h2 class="mt-3 text-center">Creer votre compte</h2>
                        <form class="mt-4" action="/study" method="get">
                            <div class="row">
                                <div class="col-lg-12">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" name="mdp" type="password" placeholder="mot de pass">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" name="Com_mdp" type="password" placeholder="Comfirmer mot de pass">
                                    </div>
                                </div>
                                <div class="col-lg-12 text-center">
                                    <button type="submit" class="btn btn-block btn-dark">Sinscrire</button>
                                </div>
                                <div class="col-lg-12 text-center mt-2">
                                    <p class="text-danger"><?php if (isset($msgError)){echo $msgError;} ?></p>
                                </div>
                                <div class="col-lg-12 text-center mt-1">
                                    Vous avez deja un compte? <a href="/login" class="text-danger">Se connecter</a>
                                </div>
                            </div>
                        </form>
                    </div>
