...
<link href="{{ asset('app-assets/assets/libs/fullcalendar/dist/fullcalendar.min.css') }}" rel="stylesheet" />
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Calendrier</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Apps</li>
                                    <li class="breadcrumb-item text-muted" aria-current="page">Calendrier</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<!-- Calendar -->
<script src="{{ asset('app-assets/assets/extra-libs/taskboard/js/jquery.ui.touch-punch-improved.js') }}"></script>
<script src="{{ asset('app-assets/assets/extra-libs/taskboard/js/jquery-ui.min.js') }}"></script>

<!--This page JavaScript Calendar -->
<script src="{{ asset('app-assets/assets/libs/moment/min/moment.min.js') }}"></script>
<script src="{{ asset('app-assets/assets/libs/fullcalendar/dist/fullcalendar.min.js') }}"></script>
<script src="{{ asset('app-assets/dist/js/pages/calendar/cal-init.js') }}"></script>
