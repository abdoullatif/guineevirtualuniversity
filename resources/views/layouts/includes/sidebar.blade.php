            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link" href="/mysubjects"
                                aria-expanded="false"><i data-feather="file-text" c
                                                         lass="feather-icon"></i><span
                                    class="hide-menu">Mes matieres
                                </span></a>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="/discutions"
                                aria-expanded="false"><i data-feather="message-square" class="feather-icon"></i><span
                                    class="hide-menu">Discusions</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="/calendrier"
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="/university"
                                aria-expanded="false"><i data-feather="edit-3" class="feather-icon"></i><span
