        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        ...
                        <h3 class="page-title text-truncate text-dark font-weight-medium mb-1"> Universite {{ auth()->user()->nomPersonne }} {{ auth()->user()->prenomPersonne }} </h3>
                        @elseif(Auth::user()->rolePersonne == 'etudiant' || Auth::user()->rolePersonne == 'professeur')
                        <h3 class="page-title text-truncate text-dark font-weight-medium mb-1"> Universite {{ $universite->nomPersonne }} {{ $universite->prenomPersonne }} </h3>
                        @endif
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    @if($infoEtude != null)
                                    <li class="breadcrumb-item"><a href="index.php"> {{ $infoEtude->nomDepartement }}</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="index.php"> {{ $infoEtude->nomFiliere }}</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="index.php"> {{ $infoEtude->nomClasse }}</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="index.php"> Matricule</a>
                                    </li>
                                    @else
                                    <li class="breadcrumb-item"><a href="index.php"> Heureux de vous revoir!</a>
                                    </li>
                                    @endif
                                </ol>
                            </nav>
            ...
            <div class="container-fluid">
                ...
                <div id="carousel-example-2" class="carousel slide carousel-fade mb-5" data-ride="carousel">
                    ...
                    <!--/.Indicators-->
                    <!--Slides  {{ asset('app-assets/assets/images/banner/banner1.png') }} -->
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            <div class="view hm-white-slight">
                                <img class="d-block w-100" src="{{ asset('app-assets/assets/images/banner/banner2.png') }}" alt="First slide">
                                <div class="mask"></div>
                            </div>
                        ...
                        <div class="carousel-item">
                            ...
                            <div class="carousel-caption">
                                ...
                                <p>Universite digital</p>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <!--Mask color-->
                            <div class="view hm-white-slight">
                                <img class="d-block w-100" src="{{ asset('app-assets/assets/images/banner/banner3.png') }}" alt="Third slide">
                                <div class="mask"></div>
                            </div>
                            <div class="carousel-caption">
                                <h3 class="h3-responsive">Tant vaut l'education, Tant vaut la nation</h3>
                                <p>Suivez vos cours ou que vous soiyez</p>
                            </div>
                        </div>
                    </div>
                    <!--/.Slides-->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="card">
                            @if($cour->type == 'video')
                            <div class="card-img" style="background-image:url({{ asset('app-assets/assets/images/cours/informatique.png') }});">
                                <div class="overlay">
                                    <div class="overlay-content">
                                        <a class="hover" href="{{ route('cours.view',['id'=>$cour->cours_id]) }}">Voir le cours</a>
                                    </div>
                                </div>
                            </div>

                            <div class="card-content">
                                <a href="{{ route('cours.view',['id'=>$cour->cours_id]) }}">
                                    <h2>{{ $cour->titre }}</h2>
                                    <p>{{ $cour->nomMatiere }}</p>
                                </a>
                            </div>
                            @elseif($cour->type == 'pdf')
                            <div class="card-img" style="background-image:url({{ asset('app-assets/assets/images/cours/informatique.png') }});">
                                <div class="overlay">
                                    <div class="overlay-content">
                                        <a class="hover" href="{{ route('cours.view.pdf',['id'=>$cour->cours_id]) }}">Voir le cours</a>
                                    </div>
                                </div>
                            </div>

                            <div class="card-content">
                                <a href="{{ route('cours.view.pdf',['id'=>$cour->cours_id]) }}">
                                    <h2>{{ $cour->titre }}</h2>
                                    <p>{{ $cour->nomMatiere }}</p>
                                </a>
                            </div>
