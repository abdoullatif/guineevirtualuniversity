            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Cours</h4>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="post" action="{{ route('cours.store') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="titre"
                                                id="inputHorizontalSuccess" placeholder="Titre du cours">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="inputHorizontalSuccess"
                                            class="col-sm-2 col-form-label">Type de contenue</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="form-group row">
                                        <label for="inputHorizontalSuccess"
                                            class="col-sm-2 col-form-label">Contenue</label>
                                        <div class="col-sm-10">
                                            <div class="input-group mb-3">
                                                ...
                                                <div class="custom-file">
                                                    <input type="file" name="contenue" class="custom-file-input" id="inputGroupFile01">
                                                    <label class="custom-file-label" for="inputGroupFile01">Selectionner un contenue</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
