            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Universite</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="index.html" class="text-muted">Dashboard</a></li>
                                    <li class="breadcrumb-item text-muted active" aria-current="page">University</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{ $universite->nomPersonne }} {{ $universite->prenomPersonne }}</td>
                                                <td>{{ $universite->adressePersonne }}</td>
                                                <td>{{ $universite->statutPersonne }}</td>
                                                <td>{{ $universite->telephonePersonne }}</td>
                                                <td>{{ $universite->email }}</td>
                                                <td>{{ $universite->dateInscriptionPersonne }}</td>
                                            </tr>
                                            @endforeach
