            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Filiere</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="index.html" class="text-muted">Filiere</a></li>
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" action="{{ route('filiere.store') }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="departement_id">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="filiere"
                                                id="inputHorizontalSuccess" placeholder="Nom de la filiere">
                                        </div>
                                    </div>
