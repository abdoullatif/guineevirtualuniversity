                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{ $professeur->nomPersonne }} {{ $professeur->prenomPersonne }}</td>
                                                <td>{{ $professeur->adressePersonne }}</td>
                                                <td>{{ $professeur->statutPersonne }}</td>
                                                <td>{{ $professeur->telephonePersonne }}</td>
                                                <td>{{ $professeur->email }}</td>
                                                <td>{{ $professeur->dateInscriptionPersonne }}</td>
                                            </tr>
                                            @endforeach
